  ...
  return (
    <>
      ...
      <label className={checkboxStyle}>
        ...
        <span className={spanStyle}>Үй жануарларына рұқсат</span>
        <input
          type="checkbox"
          name="Pets"
      ...
      <label className={checkboxStyle}>
        ...
        <span className={spanStyle}>Тегін парковка</span>
        <input
          type="checkbox"
          name="Parking"
      ...
      <label className={checkboxStyle}>
        ...
        <span className={spanStyle}>Ас үй</span>
        <input
          type="checkbox"
          name="Kitchen"
      ...
      <label className={checkboxStyle}>
        ...
        <span className={spanStyle}>Жұмыс орны</span>
        <input
          type="checkbox"
          name="Work Space"
      ...
      <label className={checkboxStyle}>
        ...
        <span className={spanStyle}>Кондиционер</span>
        <input
          type="checkbox"
          name="Aircondition"
      ...
      <label className={checkboxStyle}>
        ...
        <span className={spanStyle}>Таудың көрінісі</span>
        <input
          type="checkbox"
          name="Mountain View"
