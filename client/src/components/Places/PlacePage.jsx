        ...
        <div className="absolute inset-0 bg-white min-h-screen flex flex-col gap-4">
          <div className="bg-white fixed w-full h-14">
            <button
              ...
              className="bg-white absolute top-3 left-14 hover:bg-gray-100 rounded-full transition ease-in-out duration-200 py-1 px-2"
            >
            ...
            <div>
              {place.photos?.[1] && (
                <div>
                  <img
                    className="aspect-square object-cover rounded-2xl"
                    src={URL_TO_UPLOADS + place.photos[1]}
                  />
                </div>
              )}
            </div>
              ...
              {place.photos?.[2] && (
                <div className="overflow-hidden">
                  <img
                    ...
                    src={URL_TO_UPLOADS + place.photos[2]}
                  />
                </div>
              )}
            </div>
